...
<center>
  <form  action=" " method="post"   class="login-container"> 
    ...
    <p> <input type="text" name="fname"  placeholder="Enter First Name" value="<?php echo $row['fname']?>"/></p>
     <p><input type="text" name="lname"   placeholder="Enter Last Name" value="<?php echo $row['lname']?>"/></p>
     <p><input type="text" name="adde"   placeholder="Enter Address" value="<?php echo $row['adde']?>"/></p>
    <p><input type="text" name="mno"  placeholder="Enter Mobile Number" value="<?php echo $row['mno']?>"/></p>
...
$rq="UPDATE `regp` SET fname='$_POST[fname]' ,lname='$_POST[lname]',adde='$_POST[adde]',mno='$_POST[mno]' where username='$_POST[username]'    ";
